...
describe("Cart",function(){
    it("should add freight cost for one cart item",function(){
        var cart = new Cart();
        cart.add(new CartItem("Vara",50,1));
        expect(cart.totalPrice()).toEqual(50+50);
    });
    it("should add freight cost for many cart items",function(){
        var cart = new Cart();
        cart.add(new CartItem("Vara",50,2));
        cart.add(new CartItem("Vara",200,1));
        expect(cart.totalPrice()).toEqual(300+50);
    });
});